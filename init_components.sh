...
if [ -d './M5Unified' ]; then
    ...
    git clone --depth 1 --branch "0.1.14" https://github.com/m5stack/M5Unified.git
fi
...
if [ -d './M5GFX' ]; then
    ...
    echo 'creating M5GFX'
    git clone --depth 1 --branch "0.1.15" https://github.com/m5stack/M5GFX.git
fi
...
if [ -d './esp-modbus' ]; then
    ...
    git clone --depth 1 --branch "v1.0.13" https://github.com/espressif/esp-modbus.git
fi
